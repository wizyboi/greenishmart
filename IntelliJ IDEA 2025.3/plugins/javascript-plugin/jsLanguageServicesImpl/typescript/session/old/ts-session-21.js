    ...
    var Session21 = /** @class */ (function (_super) {
        ...
        Session21.prototype.executeCommand = function (request) {
            ...
            try {
                if (TypeScriptCommandNames.Open == command || TypeScriptCommandNames.Close == command) {
                ...
                else if (TypeScriptCommandNames.CompileOnSaveEmitFile == command) {
                    ...
                    TypeScriptCommandNames.IDEOpenExternalProject == command) {
                    //ignore
                    return util_1.doneRequest;
                }
                if (TypeScriptCommandNames.Status == command) {
                    return (0, util_1.statusResponse)(ts_impl);
                }
...
//# sourceMappingURL=ts-session-21.js.map