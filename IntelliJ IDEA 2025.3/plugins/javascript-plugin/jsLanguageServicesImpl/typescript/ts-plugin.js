...
var TypeScriptLanguagePlugin = /** @class */ (function () {
    function TypeScriptLanguagePlugin(state) {
        ...
        //compatible with ts-server: use direct args, instead of the state
        state.globalPlugins = (0, util_1.findArgumentStringArray)("--globalPlugins") || [];
        state.pluginProbeLocations = (0, util_1.findArgumentStringArray)("--pluginProbeLocations") || [];
