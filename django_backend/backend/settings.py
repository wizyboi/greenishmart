...
INSTALLED_APPS = [
    ...
    'django_filters',
    # Local
    'api',  # Using 'api' instead of 'accounts' as per project structure
]
...
ROOT_URLCONF = 'backend.urls' # Changed from greenishmart.urls
...
WSGI_APPLICATION = 'backend.wsgi.application' # Changed from greenishmart
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'GreenishMart API',
    'DESCRIPTION': 'Advanced API for GreenishMart e-commerce platform',
    'VERSION': '1.0.0',
